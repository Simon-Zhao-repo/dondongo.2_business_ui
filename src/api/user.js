...
export const registerUser = (tenantId, name, account, password, phone, email, code) =>
  request({
    url: '/blade-auth/oauth/token',
    method: 'post',
    headers: {
...
export const sendEmailCode = (email) => {
  return request({
    url: '/blade-resource/email/endpoint/send-validate',
    method: 'post',
    params: {
      email
    }
 ...
 * 校验邮箱验证码
 */
export const validateEmailCode = (email, code) => {
  return request({
    url: '/blade-resource/email/endpoint/validate-code',
    method: 'post',
    params: {
      email,
      code
 ...
 * 通过邮箱重设密码
 */
export const resetPasswordByEmail = (email, code, password) => {
  return request({
    url: '/blade-system/user/reset-password-by-email',
    method: 'post',
    params: {
      email,
      code,
